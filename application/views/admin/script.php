...
<script type="text/javascript" src="<?=base_url("public/js/popperjs.min.js")?>"></script>
<script type="text/javascript" src="<?=base_url("public/js/bootstrap.min.js")?>"></script>
<script type="text/javascript" src="<?=base_url("public/js/bootstrap.bundle.min.js")?>"></script>
<script type="text/javascript" src="<?=base_url("public/plugin/datatable/datatables.min.js")?>"></script>
